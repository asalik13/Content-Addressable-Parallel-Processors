...
For example, if we want to ignore the third character in our search, we would write mask bits [16:23] as high.
\\\\
...
Inversely, depending on the 2 search lines and the bit value, a mismatch line that is connected to the tag of the cell is set high or low. 
