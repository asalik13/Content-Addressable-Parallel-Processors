...
As all the tag bits of a CAM have to change in constant time, match lines from the search registers go through each cell to create mismatch lines which turn irrelevant tags off whenever the search signal is hi.
\begin{figure}
