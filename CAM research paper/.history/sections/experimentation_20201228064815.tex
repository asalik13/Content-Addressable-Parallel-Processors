...
This placing and routing tool was used because it accomadated factors like timing into place which was crucial for a synchronized machine like a CAM along with the Serial UART module that is use