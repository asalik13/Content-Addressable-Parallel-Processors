...
This placing and routing tool was used because it accommodated factors like timing into place. This was crucial for a synchronized machine like a CAM along with the Serial UART module that is used for control. 