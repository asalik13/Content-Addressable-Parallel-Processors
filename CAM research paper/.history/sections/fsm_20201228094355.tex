...
\end{itemize}
In a very similar manner, all commands needed to operate a CAM were designed. 
Each command can be triggered by sending a specific character to the CAM. 
Therefore, a CAM was d