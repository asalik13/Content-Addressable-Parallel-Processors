...
\end{itemize}
In a very similar manner, all commands needed to operate a CAM were designed, these commands can be triggered by sending a specific character to the CAM. 