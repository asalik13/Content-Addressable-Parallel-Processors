...
\\\\
CAMs have potential applications in graph theory, high-speed indexing, regex computations and a lot more. 
We hope that an open source CAM can fill the gap between