...
We hope that an open-source, expandable CAM that can be synt on a FPGA can fill the gap for researchers to find new applications using an alternate memory architecture. 