...
These circuits are too large to be included here, although a Verilog snippet is included in Figure 3. 
\includegraphics[width=1\columnwidth]{cells_snippet.png.png}
\caption[Short text]{Circuitry for tag registers}